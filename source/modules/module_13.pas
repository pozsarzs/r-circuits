...
const
  MODULE_ID='r13';                                                  // Module ID

Resourcestring
  MESSAGE01='Current divider';
  MESSAGE02='Iin|A|input current';
  MESSAGE03='R1|Ω|resistor';
  MESSAGE04='R2|Ω|resistor';
  MESSAGE05='Iout|A|output current';
...
begin
  try
    ii:=ValueDataIn[0]; r1:=ValueDataIn[1]; r2:=ValueDataIn[2];
    io:=ii*((r1*r2)/(r1+r2))/r2;
    ValueDataOut[0]:=io;
  except
    ValueDataOut[0]:=0;
    ErrorCode:=1;
